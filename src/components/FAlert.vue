<template>
    <div class="bg-green-50 border border-green-400 text-red-700 px-4 py-4 my-10 rounded relative" role="alert">
        <span class="block sm:inline text-center md:text-left"> {{message}}</span>
        <span class="absolute top-0 bottom-0 right-0 px-1 md:px-4 py-1 md:py-3">
